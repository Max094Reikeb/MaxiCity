...
public class Cuboid {
    ...
    public Location getRandomLocation() {
        ...
        final double x = rand.nextInt((int) (Math.abs(this.xMax - this.xMin) + 1)) + this.xMin;
        final double y = rand.nextInt((int) (Math.abs(this.yMax - this.yMin) + 1)) + this.yMin;
        final double z = rand.nextInt((int) (Math.abs(this.zMax - this.zMin) + 1)) + this.zMin;
